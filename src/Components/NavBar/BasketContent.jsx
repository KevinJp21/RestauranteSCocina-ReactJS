        ...
        <>
            ...
            {basket.length > 0 && (
                <div className="buyContainer" id="buyContainer">
                    <button className="delAllProducts" id="delAllProducts" onClick={handleOpenModal}>
                    ...
                    <BasketModal open={isModalOpen} onConfirm={handleRemoveAll} onClose={() => setModalOpen(false)} />
